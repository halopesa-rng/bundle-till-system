...
async function startPayment(){
 ...
 try{
  ...
  msg.innerHTML=`<div class="notice success"><b>Pay KES ${Number(d.amount).toFixed(0)} to Buy Goods Till ${esc(d.till||window.till||'1677484')}.</b><br>Use M-PESA → Lipa na M-PESA → Buy Goods and Services → Till ${esc(d.till||window.till||'1677484')}.<br><br>After you complete the payment, tap <b>I HAVE PAID — CONFIRM</b>. An approval request will be sent to the admin.</div>`;
